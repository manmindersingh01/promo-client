    ...
    <div className='bg-slate-900 pt-10 px-2'>
      <div className='w-full h-72 bg-slate-700 rounded-2xl flex flex-col gap-4 items-center justify-center'>
        ...
        <div className="flex w-full max-w-sm items-center space-x-2">
          ...
          <Button className='hover:scale-110 transition duration-150' variant='outline' type="submit">Subscribe</Button>
        </div>
      </div>
      <div className="bg-white">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline"> Clio Awards
