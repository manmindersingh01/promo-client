...
const Lists: React.FC = () => {
  ...
  return (
    <div className='w-full h-auto flex flex-col bg-slate-900 items-center'>
      ...
      <div className='grid md:grid-cols-4 gap-4 grid-cols-1 px-12 w-full'>
        {products.map((event, idx) => (
          <div key={idx} className="relative max-w-sm  bg-slate-950 border border-slate-900 shadow  rounded-lg  dark:bg-gray-800 dark:border-gray-700 object-cover">
            <a href="#">
            ...
            <div className="p-5">
              ...
              <div className=' flex justify-between items-center '>
                ...
                <div className=' ml-1'>
                  <Sale data={event.data.data.percentageOff} />
                </div>
              </div>
